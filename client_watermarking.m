...
% terhubung ke tcp sebagai client
...
% define variable untuk dikirim ke server
gambar_source="lena.jpg";
gambar_watermarked="watermarked.jpg";

% dua varibale itu kita masukan ke
% satu variabel dengan pemisah new line
gambar_untuk_send = gambar_source + "\n" + gambar_watermarked;

% send variable ke server
fwrite(t,gambar_untuk_send);
